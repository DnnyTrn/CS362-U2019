...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	tributeRevealedCards[1] = -1;
      ...
      for (i = 0; i < 2; i ++){
        //   per dominion rules, curse cards give no bonuses
          if (tributeRevealedCards[i] == curse)
              continue;

          //   per tribute card, tributeRevealedCards cannot be the same card for card effect to occur
          if (tributeRevealedCards[1] == -1) break;
